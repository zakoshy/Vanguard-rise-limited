...
function FeaturedListingsSection() {
  ...
  const { data: properties, isLoading } = useCollection<RealEstateListing>(listingsQuery);
    ...
    <div className="mt-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
       ...
       {!isLoading && (!properties || properties.length === 0) && (
          <p className='text-center text-muted-foreground'>No listings have been added yet.</p>
      )}
    </div>
  );
}
